######################### Path & Saving Data ######################################
rm(list = ls())
path <- "Z:/eBay/Item Delivery tpNPS/Coder/Allocation/9_Sep'17"
setwd(path)
...
cumsum(tips$sex) - #cumulative frequency distribution
...
table(df$FAST_N_FREE_YN_IND_2) - #frequency distribution of a categorical variable
#OR#
