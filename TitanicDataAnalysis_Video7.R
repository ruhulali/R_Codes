...
table(misses$parch)
table(misses$cabin)
table(misses$embarked)
summary(misses$age)

ggplot(misses[1:182,], aes(x = pclass, fill = factor(survived))) +
  geom_bar() +
  xlab("Pclass") +
  ylab("Total Count") +
  labs(fill = "Survived") 

ggplot(misses[1:182,], aes(x = embarked, fill = survived)) +
  geom_bar() +
  facet_wrap(~pclass) + 
  ggtitle("embarked vs pclass") +
  xlab("embarked") +
  ylab("Total Count") +
  labs(fill = "Survived")

ggplot(misses[1:182,], aes(x = age, fill = survived)) +
...
table(mrses$survived)
table(mrses$pclass)
table(mrses$sibsp)
table(mrses$parch)
table(mrses$cabin)
table(mrses$embarked)
summary(mrses$age)

ggplot(mrses[1:129,], aes(x = pclass, fill = factor(survived))) +
  geom_bar() +
  xlab("Pclass") +
  ylab("Total Count") +
  labs(fill = "Survived") 

ggplot(misses[1:129,], aes(x = embarked, fill = survived)) +
  geom_bar() +
  facet_wrap(~pclass) + 
  ggtitle("embarked vs pclass") +
  xlab("embarked") +
...
ggplot(mrses[1:129,], aes(x = age, fill = survived)) +
  facet_wrap(~sex + pclass) +
  geom_histogram(binwidth = 10) +
  xlab("Age") +
  ylab("Total Count")
...
table(males$parch)
table(males$cabin)
table(males$embarked)
summary(males$age)

ggplot(males[1:577,], aes(x = pclass, fill = factor(survived))) +
  geom_bar() +
  xlab("Pclass") +
  ylab("Total Count") +
  labs(fill = "Survived") 

ggplot(males[1:577,], aes(x = embarked, fill = survived)) +
  geom_bar() +
  facet_wrap(~pclass) + 
  ggtitle("embarked vs pclass") +
  xlab("embarked") +
...
ggplot(males[1:577,], aes(x = age, fill = survived)) +
  facet_wrap(~sex + pclass) +
  geom_histogram(binwidth = 10) +
  xlab("Age") +
  ylab("Total Count")
...
ggplot(boys[1:40,], aes(x = pclass, fill = factor(survived))) +
  geom_bar() +
  xlab("Pclass") +
  ylab("Total Count") +
  labs(fill = "Survived") 

ggplot(boys[1:40,], aes(x = embarked, fill = survived)) +
  geom_bar() +
  facet_wrap(~pclass) + 
  ggtitle("embarked vs pclass") +
  xlab("embarked") +
...
ggplot(boys[1:40,], aes(x = age, fill = survived)) +
  facet_wrap(~sex + pclass) +
  geom_histogram(binwidth = 10) +
  xlab("Age") +
  ylab("Total Count")
...
library(infotheo)
install.packages("infotheo", dependencies = T)
