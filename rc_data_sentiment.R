rm(list = ls())
getwd()
setwd('D:/Sentiment Analysis/RC_data/')

# Natural Language Processing

# Importing the dataset
rcove <- read.delim('rc_ove.txt', quote = '', stringsAsFactors = FALSE)
rccomment <- read.delim('rc_comment.txt', quote = '', stringsAsFactors = FALSE)
dataset_original <- c(rcove + rccomment)
dataset_original = read.delim('rc_data.txt', quote = '', stringsAsFactors = FALSE)
dataset_original = read_csv("D:/Sentiment Analysis/RC_data/rc_data.csv")
...
corpus = VCorpus(VectorSource(dataset_original$Comment))
